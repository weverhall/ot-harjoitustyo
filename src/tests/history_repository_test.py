...
class TestHistoryRepository(unittest.TestCase):
    ...
    def test_inserts_and_fetches_row_correctly(self):
        self.history.insert("melkki.cs.helsinki.fi", "128.214.9.98", "Latency: 0.430 ms")
        self.assertEqual(self.history.fetch_all(),\
    ...
    def test_inserts_and_fetches_multiple_rows_correctly(self):
        ...
        self.history.insert("australia.gov.au", "18.67.105.98", "Latency: 275.404 ms")
        self.history.insert("discord.com", "162.159.136.232", "Latency: 5.001 ms")
        self.assertEqual(self.history.fetch_all(),\
            [["australia.gov.au", "18.67.105.98", "275.4 ms", self.current_date],\
            ["discord.com", "162.159.136.232", "5 ms", self.current_date],\

...
class LookupView:
    ...
    def _handle_domain_button_click(self):
        ...
        elif output_value == "Domain is already taken":
    ...
    def _handle_ip_mac_button_click(self):
        output_ip = NetworkLookup.find_ip(self)
    ...
    def _initialize(self):
        ...
        self.domain_name_entry.grid(row=0, column=0, columnspan=2, padx=5, pady=5)    
        domain_check_button.grid(row=1, column=0, columnspan=2, padx=5, pady=5) 
        ip_mac_fetch_button.grid(row=7, column=0, columnspan=2, padx=5, pady=5)
